...
window.addEventListener('load', (e) => {
    ...
    if (url === "/index.html" || url === "/") {
        ...
        console.log("estoy arriba dentro del switch");
        switch (url) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data["resultado"], function (llave, valor) {
                ...
                template += '<a href="#" class="btn btn-warning" data-toggle="modal" onclick="modalCorroborarPassword(' + valor["idEmpleado"] + ')"><i class="gg-info"></i></a>';
                template += '</button>';
                template += '<button class="btn">';
...
// voy a comentar EventSource, no afecta en si...
...
//                 template += '<div class="btn-group">';
//                 template += '<button class="btn">';
//                 template += '<a href="#" class="btn btn-warning" data-toggle="modal" data-target="#modalCorroborar Password" onclick="modalCorroborar Password(' + valor["idEmpleado"] + ')"><i class="gg-info"></i></a>';
//                 template += '</button>';
...
function empInsert() {
    ...
    $.ajax({
        type: "POST",
        url: domMainEmpleados + "categorias/create/",
        data: registrosEmpl,
        dataType: 'json',
        contentType: false,
        enctype: 'multipart/form-data',
